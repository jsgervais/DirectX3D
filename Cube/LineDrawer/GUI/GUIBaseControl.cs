...
namespace LineDrawer.GUI
{
    class GUIBaseControl:IRenderable, IUpdatableItem
    {
        ...
        public virtual void DrawHover(Device device, Matrix worldViewMatrix)
        {
        ...
        /// </summary>
        /// <param name="renderTarget"></param>
        public virtual void DrawFocus(Device device, Matrix worldViewMatrix)
        {
        ...
        /// </summary>
        /// <param name="renderTarget"></param>
        public virtual void Render(Device device, Matrix worldViewMatrix)
        {
