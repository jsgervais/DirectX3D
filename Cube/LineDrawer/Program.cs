...
namespace LineDrawer
{
    ...
    /// </summary>
    partial class Program : SharpDx3D11Base
    {
        ...
        private DrawMode _currentDrawMode = DrawMode.Cubes;
        ...
        protected override void OnRender()
        {
            ...
            {
                item.Render(Device,  WorldViewMatrix);
            }

            //Render current line if not null "?." operator  
            ((IRenderableItem)_currentDrawing)?.Render( Device, WorldViewMatrix);

            //At last, display GUI on top of everything
           // _guiManager.Render(Device, WorldViewMatrix);
